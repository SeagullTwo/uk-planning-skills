...
description: >-
  ...
  presumption in favour of sustainable development (policies S3–S6 of the
  August 2026 coded NPPF, replacing the old paragraph-11 "tilted balance"),
  emerging-plan weight, and the tests for planning conditions and obligations.
  Includes a December 2024 → August 2026 citation crosswalk. Used by the
  triage and representation skills; also answers direct "what does the NPPF
  say / is this policy current" questions. England-focused. Not legal
...
- **Topic catalogues:** the representation skills' catalogues are being re-mapped to the new
  ...
  verification note before citing from it, and use `references/nppf-crosswalk-2026.md` for
